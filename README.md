...
文档版本 | 修订日期| 修订说明
---|---|---
V1.0.0.0 | 20191021 | 初始化SDK,同时支持支持激励视频类和激励互动类型广告
V1.2.0.0 | 20191021 | 1.增加关闭事件回调 2.解决奖励回调多次问题
V1.2.2.2 | 20191021 | 1.增加非全屏视频类活动导航栏 2.优化下载器
V1.2.2.5 | 20191021 | 修改广告请求方式,优化广告投放
V1.2.2.7 | 20191015 | 1.优化广告请求方式 2.优化下载性能  3.增加关键日志 4.增加关闭事件的发奖通知
V1.2.2.8 | 20191021 | 1.优化发奖回调时机 2.禁用webview 缩放控制，避免引起内存泄漏
